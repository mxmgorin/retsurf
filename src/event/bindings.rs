...
impl Action {
    ...
    pub fn command(self, pressed: bool) -> Option<AppCommand> {
        Some(match self {
            ...
            Action::ZoomIn => AppCommand::Input(InputCommand::Zoom(1)),
            Action::ZoomOut => AppCommand::Input(InputCommand::Zoom(-1)),
            Action::ZoomReset => AppCommand::Input(InputCommand::Zoom(0)),
